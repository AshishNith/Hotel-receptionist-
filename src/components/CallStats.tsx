  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-3xl p-5 shadow-sm">
      <h3 className="text-[10px] font-semibold tracking-[0.2em] text-zinc-500 uppercase mb-3 flex items-center gap-2 font-mono">
        <Activity className="w-3.5 h-3.5 text-orange-600" /> Live Call Telemetry
      </h3>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Codec */}
        <div className="bg-zinc-50 p-4 rounded-2xl border border-zinc-200 font-mono">
        ...
        <div className="bg-zinc-50 p-4 rounded-2xl border border-zinc-200 font-mono">
          ...
          <span className="text-xs font-semibold text-zinc-800 mt-1 block flex items-center gap-1.5">
        ...
        <div className="bg-zinc-50 p-4 rounded-2xl border border-zinc-200 font-mono">
          <span className="text-[9px] text-zinc-500 uppercase tracking-widest block flex items-center gap-1.5">
            <Clock className="w-3 h-3 text-cyan-600" /> Call Duration
          </span>
          <span className={`text-xs font-bold mt-1 block ${callState === "connected" ? "text-cyan-600" : "text-zinc-500"}`}>
        ...
        <div className="bg-zinc-50 p-4 rounded-2xl border border-zinc-200 font-mono">
          <span className="text-[9px] text-zinc-500 uppercase tracking-widest block flex items-center gap-1.5">
            <HardDriveDownload className="w-3 h-3 text-orange-600" /> Audio Packets
          </span>
